...
export class Player {
    ...
    */
    ...
    static initialActions(model) {
        ...
        model.runActionList = {};
        model.runActionList['Idle'] = model.mixer.clipAction(model.animations[5]);
        model.runActionList['RunForward'] = model.mixer.clipAction(model.animations[3]);
        model.runActionList['RunBackwards'] = model.mixer.clipAction(model.animations[10]);
        model.runActionList['RunLeft'] = model.mixer.clipAction(model.animations[0]);
        model.runActionList['RunRight'] = model.mixer.clipAction(model.animations[4]);
        model.runActionList['RunForwardLeft'] = model.mixer.clipAction(model.animations[2]);
        model.runActionList['RunForwardRight'] = model.mixer.clipAction(model.animations[14]);
        model.runActionList['RunBackwardLeft'] = model.mixer.clipAction(model.animations[1]);
        model.runActionList['RunBackwardRight'] = model.mixer.clipAction(model.animations[12]);
        model.jumpActionList = {};
        model.jumpActionList['Jump'] = model.mixer.clipAction(model.animations[13]);
        model.fireActionList = {};
        model.fireActionList['FiringRifle'] = model.mixer.clipAction(model.animations[8]);
        model.deathActionList = {};
        model.deathActionList['DeathFromTheFront'] = model.mixer.clipAction(model.animations[7]);
        model.deathActionList['DeathFromTheBack'] = model.mixer.clipAction(model.animations[11]);
        model.deathActionList['DeathFromFrontHeadshot'] = model.mixer.clipAction(model.animations[9]);
        model.deathActionList['DeathFromBackHeadshot'] = model.mixer.clipAction(model.animations[6]);
    }
